...
petik = '```'
fake = 'SALBOTZ'//GANTI NAMA KAMU BEP
ban =[]
...
➸ *Sejak* : ${getTime}`
 ...
 case 'donasi':
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: 'TERIMAKASIH SUDAH MAU DONASI',
               buttons: buttons,
               headerType: 1
}
...
*き⃟🕊️ ${prefix}botstat*
*き⃟🕊️ ${prefix}sewabot*
*き⃟🕊️ ${prefix}listsewa*
*き⃟🕊️ ${prefix}owner*
*き⃟🕊️ ${prefix}ping*
*き⃟🕊️ ${prefix}runtime*
*き⃟🕊️ ${prefix}donasi*
*き⃟🕊️ ${prefix}leaderboard*
*き⃟🕊️ ${prefix}cekpremium*
...
*き⃟🕊️ ${prefix}kontak* _nomor|nama_
*き⃟🕊️ ${prefix}ceksewa*
*き⃟🕊️ ${prefix}kickall*
*き⃟🕊️ ${prefix}infogrup*
*き⃟🕊️ ${prefix}promote*
*き⃟🕊️ ${prefix}promoteall*
*き⃟🕊️ ${prefix}demote*
*き⃟🕊️ ${prefix}demoteall*
*き⃟🕊️ ${prefix}listonline*
*き⃟🕊️ ${prefix}tagall* _teks_
*き⃟🕊️ ${prefix}leave*
...
*き⃟🕊️ ${prefix}tictactoe* _@tag_
*き⃟🕊️ ${prefix}siapaaku*
*き⃟🕊️ ${prefix}family100*
*き⃟🕊️ ${prefix}kuismath*
*き⃟🕊️ ${prefix}asahotak*
*き⃟🕊️ ${prefix}tebaklirik*
*き⃟🕊️ ${prefix}tebaklagu*
*き⃟🕊️ ${prefix}tebakkata*
*き⃟🕊️ ${prefix}susunkata*
*き⃟🕊️ ${prefix}kimiakuis*
*き⃟🕊️ ${prefix}caklontong*
*き⃟🕊️ ${prefix}tebakjenaka*
*き⃟🕊️ ${prefix}tebakanime*
*き⃟🕊️ ${prefix}tebaktebakan*
*き⃟🕊️ ${prefix}tebakgambar*
*き⃟🕊️ ${prefix}tebakumur*
*き⃟🕊️ ${prefix}tebakbendera*
*き⃟🕊️ ${prefix}suit* _batu/kertas/gunting_

𝖨𝖲𝖫𝖠𝖬 𝖬𝖤𝖭𝖴
*き⃟🕊️ ${prefix}kisahnabi*
*き⃟🕊️ ${prefix}jadwalsholat*
*き⃟🕊️ ${prefix}alquran*
*き⃟🕊️ ${prefix}asmaulhusna*
*き⃟🕊️ ${prefix}alquranaudio*
*き⃟🕊️ ${prefix}listsurah*
...
*き⃟🕊️ ${prefix}ytmp3*
*き⃟🕊️ ${prefix}ytmp4*
*き⃟🕊️ ${prefix}soundcloud*
*き⃟🕊️ ${prefix}tiktoknowm*
*き⃟🕊️ ${prefix}tiktokaudio*
...
*き⃟🕊️ ${prefix}coffe* _teks_

𝖲𝖤𝖱𝖳𝖨𝖥𝖨𝖪𝖠𝖳 𝖬𝖤𝖭𝖴
*き⃟🕊️ ${prefix}sertitolol* _teks_
...
𝖣𝖤𝖶𝖠𝖲𝖠 𝖬𝖤𝖭𝖴 
*き⃟🕊️ ${prefix}xnxx* _link_
*き⃟🕊️ ${prefix}xnxxsearch*
*き⃟🕊️ ${prefix}asupan*
...
*き⃟🕊️ ${prefix}tourl*
*き⃟🕊️ ${prefix}tinyurl*
*き⃟🕊️ ${prefix}bilamgangka*
*き⃟🕊️ ${prefix}artimimpi*
*き⃟🕊️ ${prefix}resepmasakan*
...
*き⃟🕊️ ${prefix}term*
*き⃟🕊️ ${prefix}eval*
*き⃟🕊️ ${prefix}clearall*
*き⃟🕊️ ${prefix}leaveall*
*き⃟🕊️ ${prefix}join* _teks_
*き⃟🕊️ ${prefix}shutdown*
*き⃟🕊️ ${prefix}getquoted*
*き⃟🕊️ ${prefix}addupdate* _fiturnya_
*き⃟🕊️ ${prefix}exif* _nama|author_
*き⃟🕊️ ${prefix}sewa add/del* _waktunya_
*き⃟🕊️ ${prefix}premium add* _@tag|nomor_
*き⃟🕊️ ${prefix}premium del* _@tag|nomor_
*き⃟🕊️ ${prefix}setpp*
*き⃟🕊️ ${prefix}setbio*
*き⃟🕊️ ${prefix}setname*
*き⃟🕊️ ${prefix}getpp*
...
*き⃟🕊️ ${prefix}playstore* _query_
*き⃟🕊️ ${prefix}ssweb* _query_
*き⃟🕊️ ${prefix}google* _query_
*き⃟🕊️ ${prefix}image* _query_
*き⃟🕊️ ${prefix}pinterest* _query_

𝖥𝖴𝖭 𝖬𝖤𝖭𝖴 
*き⃟🕊️ ${prefix}mining*
*き⃟🕊️ ${prefix}cekwatak*
*き⃟🕊️ ${prefix}cekmati* _nama_
*き⃟🕊️ ${prefix}wangy* _nama_
*き⃟🕊️ ${prefix}citacita*
*き⃟🕊️ ${prefix}toxic*
*き⃟🕊️ ${prefix}truth*
*き⃟🕊️ ${prefix}dare*
*き⃟🕊️ ${prefix}apakah*
*き⃟🕊️ ${prefix}bisakah*
*き⃟🕊️ ${prefix}kapankah*
*き⃟🕊️ ${prefix}rate*
*き⃟🕊️ ${prefix}jadian*
*き⃟🕊️ ${prefix}cantik*
*き⃟🕊️ ${prefix}ganteng*
...
*き⃟🕊️ ${prefix}cekcantik*`
               buttons = [{buttonId: `${prefix}rules`,buttonText:{displayText: '𝗥𝗨𝗟𝗘𝗦'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`Tidak Semua Fitur Work Ya kak\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
\`\`\`き⃟🕊️ Username : ${res.data.owner}\`\`\`
\`\`\`き⃟🕊️ Caption : ${res.data.caption}\`\`\``, {thumbnail: Buffer.alloc(0)})
}
              } catch (e) {
              console.log(e)
              reply(String(e))
...
*Data Berhasil Didapatkan!*
\`\`\`き⃟🕊️ Title : ${res[0].judul}\`\`\`
\`\`\`き⃟🕊️ Ext : MP3\`\`\`
\`\`\`き⃟🕊️ Size : ${res[0].size}\`\`\`
...
*Data Berhasil Didapatkan!*
\`\`\`き⃟🕊️ Nama : ${res[0].nama}\`\`\`
\`\`\`き⃟🕊️ Ukuran : ${res[0].size}\`\`\`
\`\`\`き⃟🕊️ Link : ${res[0].link}\`\`\`
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Follow Ig @fisal.adriansyah', imageMessage: imageMsg,
      ...
      case 'kusonime':
       ...
       case 'nekopoi':
              ...
              get_result = get_result.result
              ini_txt = `\`\`\`き⃟🕊️ Title : ${get_result.anime}\`\`\`\n`
              ini_txt += `\`\`\`き⃟🕊️ Porducers : ${get_result.producers}\`\`\`\n`
              ini_txt += `\`\`\`き⃟🕊️ Duration : ${get_result.duration}\`\`\`\n`
              ini_txt += `\`\`\`き⃟🕊️ Size : ${get_result.size}\`\`\`\n`
              ini_txt += `\`\`\`き⃟🕊️ Sinopsis : ${get_result.sinopsis}\`\`\`\n`
       ...
       case 'nekopoisearch':
              ...
              ini_txt += `\`\`\`き⃟🕊️ Title : ${x.title}\`\`\`\n`
              ini_txt += `\`\`\`き⃟🕊️ Link : ${x.link}\`\`\`\n`
              ini_txt += `\`\`\`き⃟🕊️ Thumbnail : ${x.thumbnail}\`\`\`\n\n`
}
              reply(ini_txt)
              break
       case 'neko':
...
teks += `\`\`\`き⃟🕊️ Nama : ${get_data[i].name}\`\`\`
\`\`\`き⃟🕊️ Harga : ${get_data[i].harga}\`\`\`
\`\`\`き⃟🕊️ Terjual : ${get_data[i].terjual}\`\`\`
\`\`\`き⃟🕊️ Lokasi : ${get_data[i].location}\`\`\`
\`\`\`き⃟🕊️ Deskripsi*: ${get_data[i].desc}\`\`\`
\`\`\`き⃟🕊️ Stok : ${get_data[i].stock}\`\`\`
\`\`\`き⃟🕊️ Informasi : ${get_data[i].information}\`\`\`
\`\`\`き⃟🕊️ Link : ${get_data[i].url}\`\`\``
}
...
teks += `\`\`\`き⃟🕊️ Title : ${get_result[i].title}\`\`\`
\`\`\`き⃟🕊️ Harga : ${get_result[i].price}\`\`\`
\`\`\`き⃟🕊️ Rate : ${get_result[i].rating}\`\`\`
\`\`\`き⃟🕊️ Link : ${get_result[i].url}\`\`\`
...
a += `\`\`\`き⃟🕊️ Title : ${i.title}\`\`\`
\`\`\`き⃟🕊️ Views : ${i.views}\`\`\`
\`\`\`き⃟🕊️ Upload : ${i.ago}\`\`\`
\`\`\`き⃟🕊️ Durasi : ${i.timestamp}\`\`\`
\`\`\`き⃟🕊️ Channel : ${i.author.name}\`\`\`
\`\`\`き⃟🕊️ Link : ${i.url}\`\`\``
}
               b = a.trim()
...
*Data Berhasil Didapatkan!*
\`\`\`き⃟🕊️ Username : ${ini_result.name}\`\`\`
\`\`\`き⃟🕊️ Public Repo : ${ini_result.public_repos}\`\`\`
\`\`\`き⃟🕊️ Public Gists : ${ini_result.public_gists}\`\`\`
\`\`\`き⃟🕊️ Pengikut : ${ini_result.followers}\`\`\`
\`\`\`き⃟🕊️ Following : ${ini_result.following}\`\`\`
\`\`\`き⃟🕊️ Mengikuti : ${ini_result.bio}\`\`\`
\`\`\`き⃟🕊️ Link : ${ini_result.url}\`\`\`
`
...
*Data Berhasil Didapatkan!*
\`\`\`き⃟🕊️ Username : ${ini_result.username}\`\`\`
\`\`\`き⃟🕊️ Nama : ${ini_result.fullname}\`\`\`
\`\`\`き⃟🕊️ Pengikut : ${ini_result.followers}\`\`\`
\`\`\`き⃟🕊️ Mengikuti : ${ini_result.following}\`\`\`
\`\`\`き⃟🕊️ Deskripsi : ${ini_result.bio}\`\`\`
\`\`\`き⃟🕊️ Link : https://instagram.com/${ini_result.username}\`\`\`
`
             dha.sendMessage(from, ini_buffer, image, { caption: ini_txt, thumbnail: Buffer.alloc(0) })
             break
      case 'stalktiktok':
...
*Data Berhasil Didapatkan!*
\`\`\`き⃟🕊️ Username : ${get_result.username}\`\`\`
\`\`\`き⃟🕊️ Nama : ${get_result.nickname}\`\`\`
\`\`\`き⃟🕊️ Pengikut : ${get_result.followers}\`\`\`
\`\`\`き⃟🕊️ Mengikuti : ${get_result.followings}\`\`\`
\`\`\`き⃟🕊️ Likes : ${get_result.likes}\`\`\`
\`\`\`き⃟🕊️ Video : ${get_result.video}\`\`\`
\`\`\`き⃟🕊️ Deskripsi : ${get_result.bio}\`\`\`
`
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`Sherlynn-Botz ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
"groupName": `Sherlynn-Botz ~ 404 ${vipi}`,
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`Jangan Lupa Follow Ig owner:\n https://www.instagram.com/fisal.adriansyah`)
              break
       case 'masukandata':
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              dha.sendMessage('6288803441624@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
case 'tahta':
         ...
         break    
case 'pornhub':
         if (args.length == 0) return reply(`Contoh: ${prefix + command} Sherlynn-Botz`)
         txt1 = args[0]
         txt2 = args[1]
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
             ...
             break
           case 'gopay':
             reply(`GOPAY : 088803441624\n\n SAYA CUMAN BISA BILANG TERIMAKASIH ATAS KEMURAHAN HATI TUAN TELAH MEMBERIKAN KAMI BANTUAN.SEMOGA ALLAH MEMBALAS APA YG TUAN BERIKAN KE PADA SAYA`)
             break  
         case 'pulsa':
             reply(`PULSA : 088803441624\n\n SAYA CUMAN BISA BILANG TERIMAKASIH ATAS KEMURAHAN HATI TUAN TELAH MEMBERIKAN KAMI BANTUAN.SEMOGA ALLAH MEMBALAS APA YG TUAN BERIKAN KE PADA SAYA`)
             break              
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/fisal.adriansyah`)
             break
      case 'grupbot':
